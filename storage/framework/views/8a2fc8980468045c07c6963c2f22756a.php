...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layout','data' => ['title' => 'Live Employees']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Live Employees']); ?>
        ...
        <script>
            window.addEventListener('load', () => {
                ...
                async function refreshEmployees() {
                    const response = await fetch('<?php echo e(route('live-employees.data')); ?>', {
...
<?php endif; ?>
<?php /**PATH /Users/dhiman/Documents/projects/energyProject/resources/views/admin/live-employees/index.blade.php ENDPATH**/ ?>