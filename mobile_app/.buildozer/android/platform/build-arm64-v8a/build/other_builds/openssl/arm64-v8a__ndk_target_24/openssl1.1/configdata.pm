...
our %config = (
  ...
  CFLAGS => [ "-target aarch64-linux-android24 -fomit-frame-pointer -march=armv8-a -fPIC" ],
  CPPDEFINES => [ "__ANDROID_API__=24" ],
  CPPFLAGS => [ "-DANDROID -I/Users/dhiman/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/darwin-x86_64/sysroot/usr/include -I/Users/dhiman/Documents/projects/energyProject/mobile_app/.buildozer/android/platform/build-arm64-v8a/build/python-installs/poweraudit/arm64-v8a/include/python3.1" ],
  CPPINCLUDES => [  ],
  CXX => "/Users/dhiman/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/darwin-x86_64/bin/clang++ -target aarch64-linux-android24 -fomit-frame-pointer -march=armv8-a -fPIC",
  CXXFLAGS => [ "-target aarch64-linux-android24 -fomit-frame-pointer -march=armv8-a -fPIC" ],
  ...
  libdir => "",
  major => "1",
  makedepprog => "\$(CROSS_COMPILE)aarch64-linux-android24-clang",
  minor => "1.1",
  ...
  perlenv => {
      ...
      "PERL" => undef,
      "RANLIB" => "/Users/dhiman/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/darwin-x86_64/bin/llvm-ranlib",
      "RC" => undef,
      "RCFLAGS" => undef,
      "WINDRES" => undef,
      "__CNF_CFLAGS" => undef,
